              ...
              <div className="row">
                <div className="col-lg-7">
                  <h3 className="text-display-4 mt-30">
                    Осигурете уникално и запомнящо се изживяване при плащане,
                    за да изградите лоялност към клиентите.
                  </h3>
                  <div className="mt-40">
                    <Link href="https://youtu.be/ogGpM_MlruI">
                ...
                <div className="list-icons mt-50">
                  <div className="item-icon">
                    ...
                    <p className="text-body-text color-gray-600 mt-15">
                      Началото е лесно - просто изберете своето устройство с
                      камера.
                    </p>
                  </div>
                </div>
