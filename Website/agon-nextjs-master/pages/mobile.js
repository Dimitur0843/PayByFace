              ...
              <div className="row">
                <div className="col-lg-7">
                  <h3 className="text-display-4 mt-30">
                    Идеалното решение за приемане на плащания
                    в движение без допълнителен хардуер!
                  </h3>
                  <div className="mt-40">
                    <Link href="https://www.youtube.com/watch?v=tiEERLykNI4">
                ...
                <div className="col-lg-5 d-none d-lg-block">
                  <div className="banner-imgs">
                    <div style={{ borderRadius: '50px', overflow: 'hidden' }}>
                      <img src="assets/imgs/page/services/1/13.webp" layout="fill" objectFit="cover" />
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="list-icons mt-50">
                  <div className="item-icon">
                    ...
                    <p className="text-body-text color-gray-600 mt-15">
                      Лесно е да започнете, просто използвайте своя
                      собствен телефон.
                    </p>
                  </div>
                </div>
